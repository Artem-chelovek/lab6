...
Конечно! Вот анализ алгоритма Bubble Sort по вашему изначальному плану, с учетом только худшей временной сложности и указанием, какие циклы на нее влияют:
